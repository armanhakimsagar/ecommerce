  ...
  @section('single')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <h2> Welcome to Who we are </h2>

            <p><a href="{{ url('ourpeople') }}">About Us </a></p>
            <p><a href="{{ url('ethics') }}">Our Ethics </a></p>
            <p><a href="{{ url('ourpeople') }}">Our People </a></p>
            <p><a href="{{ url('news') }}">News & Events </a></p>
